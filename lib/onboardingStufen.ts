...
export const STUFEN: Stufe[] = [
  {
    abProzent: 0,
    rang: 'Leinen los',
    spruch: 'Willkommen an Bord. Ihre Argo liegt bereit.',
  ...
  },
  {
    ...
    ausblick: 'Noch ein paar Handgriffe, dann arbeitet das System für Sie statt umgekehrt.',
    farbe: '#8fb8c4',
  },
  {
    abProzent: 25,
    rang: 'Leichtmatrose',
    spruch: 'Ein Viertel liegt hinter Ihnen. Sie kennen jetzt den Weg.',
    ausblick: 'Ab hier merken Sie, wie die Module ineinandergreifen.',
    farbe: '#a8c9d1',
  },
  {
    abProzent: 40,
    rang: 'Bootsmann',
    spruch: 'Die Grundausstattung steht. Ihr Betrieb ist im System angekommen.',
    ausblick: 'Jetzt kommen die Teile, die Ihnen täglich Zeit sparen.',
    farbe: '#C9A84C',
  },
  {
    abProzent: 60,
    rang: 'Steuermann',
    spruch: 'Über die Hälfte. Sie steuern Ihren Betrieb jetzt selbst.',
  ...
  },
  {
    abProzent: 100,
    rang: 'Kapitän',
    spruch: 'Geschafft. Sie führen Ihren Betrieb mit ARGONAUT.',
    ausblick: 'Ihr Abschluss-Zertifikat liegt bereit — herzlichen Glückwunsch.',
    farbe: '#4CAF7D',
  },
];
