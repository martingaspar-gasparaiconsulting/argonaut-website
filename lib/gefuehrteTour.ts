...
export const STANDARD_TOUR: TourSchritt[] = [
  { selector: 'a[href="/dashboard"]', titel: 'Ihre Übersicht', text: 'Über das Logo oben links kommen Sie jederzeit hierher zurück — Ihr Startbildschirm mit den wichtigsten Zahlen.' },
  { selector: 'a[href="/dashboard/crm"]', titel: 'Hier ist Ihr CRM', text: 'Kunden und Firmen anlegen und pflegen. Das ist die Basis — daraus entstehen Angebote und Rechnungen.' },
  { selector: 'a[href="/dashboard/pipeline"]', titel: 'Ihre Deal-Pipeline', text: 'Vertriebschancen als Karten über die Stufen ziehen. ARGONAUT rechnet den gewichteten Forecast und zeigt je Deal einen 🔥-Score.' },
  ...
  { selector: 'a[href="/dashboard/termine"]', titel: 'Ihr Kalender', text: 'Termine planen und im Blick behalten — verzahnt mit Aufträgen und Kunden.' },
  { selector: 'a[href="/dashboard/finanzen"]', titel: 'Ihre Finanzen', text: 'Einnahmen, Ausgaben und der Überblick — alles läuft hier zusammen.' },
  { selector: 'a[href="/dashboard/documents"]', titel: 'Dokumente', text: 'Alle Unterlagen sicher an einem Ort, jederzeit griffbereit.' },
  { selector: 'a[href="/dashboard/import"]', titel: 'Daten übernehmen', text: 'Schon Daten im alten System? Im Import-Center übernehmen Sie Kunden, Artikel & Co. per CSV-Vorlage in Minuten.' },
  { selector: 'a[href="/dashboard/einstellungen"]', titel: 'Einrichten & Team', text: 'Zum Schluss: Firmendaten, Logo und Ihr Team. Hier machen Sie ARGONAUT zu Ihrem System.' },
];
