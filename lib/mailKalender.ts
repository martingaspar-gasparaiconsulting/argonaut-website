...
export const MAIL_ANBIETER: MailAnbieter[] = [
  ...
  },
  {
    ...
    bereiche: ['E-Mail'],
    hinweis: 'Zugangsdaten aus Ihrem E-Mail-Anbieter (z. B. IONOS, GMX, Strato). Bei aktivierter Zwei-Faktor-Anmeldung bitte ein „App-Passwort“ verwenden.',
    extraFelder: [
      { key: 'imap_host', label: 'IMAP-Server (Empfang)', typ: 'text', hinweis: 'z. B. imap.ionos.de · imap.gmx.net · imap.strato.de' },
      { key: 'imap_port', label: 'Port Empfang (optional)', typ: 'text', hinweis: 'Standard 993 (SSL) — meist leer lassen' },
      { key: 'smtp_host', label: 'SMTP-Server (Versand, optional)', typ: 'text', hinweis: 'Leer lassen — wird aus dem IMAP-Server abgeleitet (imap.ionos.de wird zu smtp.ionos.de)' },
      { key: 'smtp_port', label: 'Port Versand (optional)', typ: 'text', hinweis: 'Standard 587 (STARTTLS) · 465 bei durchgehender Verschlüsselung' },
    ],
    abrufbar: true,
  },
  {
