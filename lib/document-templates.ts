  ...
  },
{
  ...
  },
  {
    ...
    id: "preisanfrage",
    name: "Preisanfrage",
    beschreibung: "Anfrage nach einem Preisangebot bei einem Lieferanten.",
    format: "docx",
    agent: "Der Einkaeufer",
    felder: [
      { key: "lieferant_name", label: "Name des Lieferanten", typ: "text", pflicht: true },
      { key: "lieferant_adresse", label: "Adresse des Lieferanten", typ: "mehrzeilig", pflicht: false },
      { key: "artikel", label: "Angefragte Artikel / Leistungen", typ: "mehrzeilig", pflicht: true },
      { key: "menge", label: "Gewuenschte Menge", typ: "text", pflicht: false, beispiel: "50 Stueck" },
      { key: "liefertermin", label: "Gewuenschter Liefertermin", typ: "datum", pflicht: false },
      { key: "antwort_bis", label: "Antwort erbeten bis", typ: "datum", pflicht: false },
      { key: "datum", label: "Datum", typ: "datum", pflicht: true },
    ],
  },
  {
    id: "widerspruch",
    name: "Widerspruch / Einspruch",
    beschreibung: "Allgemeines Widerspruchs- oder Einspruchsschreiben.",
    format: "docx",
    agent: "Der Jurist",
    felder: [
      { key: "empfaenger_name", label: "Name des Empfaengers (Behoerde, Firma)", typ: "text", pflicht: true },
      { key: "empfaenger_adresse", label: "Adresse des Empfaengers", typ: "mehrzeilig", pflicht: true },
      { key: "bezug", label: "Bezug (Bescheid, Aktenzeichen, Datum)", typ: "text", pflicht: true, beispiel: "Bescheid vom 01.06.2026, Az. 12345" },
      { key: "begruendung", label: "Begruendung des Widerspruchs", typ: "mehrzeilig", pflicht: true },
      { key: "forderung", label: "Was wird gefordert", typ: "text", pflicht: false, beispiel: "Aufhebung des Bescheids" },
      { key: "datum", label: "Datum", typ: "datum", pflicht: true },
    ],
  },
  {
    id: "referenzschreiben",
    name: "Referenz- / Empfehlungsschreiben",
    beschreibung: "Empfehlungsschreiben fuer eine Person oder ein Unternehmen.",
    format: "docx",
    agent: "Der Assistent",
    felder: [
      { key: "empfohlene_person", label: "Name der empfohlenen Person / Firma", typ: "text", pflicht: true },
      { key: "beziehung", label: "Art der Zusammenarbeit / Beziehung", typ: "text", pflicht: false, beispiel: "Geschaeftspartner seit 2022" },
      { key: "zeitraum", label: "Zeitraum der Zusammenarbeit", typ: "text", pflicht: false, beispiel: "2022 bis 2026" },
      { key: "leistungen", label: "Erbrachte Leistungen / Staerken", typ: "mehrzeilig", pflicht: true },
      { key: "empfehlung", label: "Konkrete Empfehlung", typ: "mehrzeilig", pflicht: false },
      { key: "datum", label: "Datum", typ: "datum", pflicht: true },
    ],
  },
  {
    ...
    beschreibung: "Kurze Pressemitteilung zu einem Unternehmensthema.",
    format: "docx",
    agent: "Der Assistent",
    felder: [
      { key: "titel", label: "Titel / Schlagzeile", typ: "text", pflicht: true, beispiel: "ARGONAUT OS startet neue Funktion" },
      { key: "ort_datum", label: "Ort und Datum", typ: "text", pflicht: false, beispiel: "Boeblingen, 15.06.2026" },
      { key: "kernaussage", label: "Kernaussage / Lead", typ: "mehrzeilig", pflicht: true },
      { key: "text", label: "Haupttext", typ: "mehrzeilig", pflicht: false },
      { key: "zitat", label: "Zitat (z. B. der Geschaeftsfuehrung)", typ: "mehrzeilig", pflicht: false },
      { key: "kontakt", label: "Pressekontakt", typ: "mehrzeilig", pflicht: false },
    ],
  },
  {
    id: "lohnaenderung",
    name: "Lohnaenderungsschreiben",
    beschreibung: "Mitteilung ueber eine Gehalts- oder Lohnaenderung an einen Mitarbeiter.",
    format: "docx",
    agent: "Der Personaler",
    felder: [
      { key: "arbeitnehmer_name", label: "Name des Arbeitnehmers", typ: "text", pflicht: true },
      { key: "arbeitnehmer_adresse", label: "Adresse des Arbeitnehmers", typ: "mehrzeilig", pflicht: false },
      { key: "bisheriges_gehalt", label: "Bisheriges Bruttogehalt", typ: "betrag", pflicht: false, beispiel: "3800.00" },
      { key: "neues_gehalt", label: "Neues Bruttogehalt", typ: "betrag", pflicht: true, beispiel: "4100.00" },
      { key: "gueltig_ab", label: "Gueltig ab", typ: "datum", pflicht: true },
      { key: "begruendung", label: "Begruendung (optional)", typ: "mehrzeilig", pflicht: false },
      { key: "datum", label: "Datum des Schreibens", typ: "datum", pflicht: true },
    ],
  },
  {
    id: "stundenzettel",
    name: "Stundenzettel",
    beschreibung: "Tabellarische Zeiterfassung (Excel).",
    format: "xlsx",
    agent: "Der Personaler",
    felder: [
      { key: "mitarbeiter_name", label: "Name des Mitarbeiters", typ: "text", pflicht: true },
      { key: "zeitraum", label: "Zeitraum (z. B. Monat)", typ: "text", pflicht: true, beispiel: "Juni 2026" },
      { key: "datum", label: "Datum", typ: "text", pflicht: false, beispiel: "01.06.2026" },
      { key: "beginn", label: "Arbeitsbeginn", typ: "text", pflicht: false, beispiel: "08:00" },
      { key: "ende", label: "Arbeitsende", typ: "text", pflicht: false, beispiel: "17:00" },
      { key: "pause", label: "Pause (Minuten)", typ: "zahl", pflicht: false, beispiel: "60" },
      { key: "stunden", label: "Stunden gesamt", typ: "zahl", pflicht: false, beispiel: "8" },
    ],
  },
  {
    id: "reisekostenabrechnung",
    name: "Reisekostenabrechnung",
    beschreibung: "Abrechnung von Reisekosten (Excel).",
    format: "xlsx",
    agent: "Der Buchhalter",
    felder: [
      { key: "mitarbeiter_name", label: "Name des Mitarbeiters", typ: "text", pflicht: true },
      { key: "anlass", label: "Anlass der Reise", typ: "text", pflicht: true, beispiel: "Kundentermin Muenchen" },
      { key: "datum", label: "Reisedatum", typ: "text", pflicht: false, beispiel: "10.06.2026" },
      { key: "fahrtkosten", label: "Fahrtkosten", typ: "betrag", pflicht: false, beispiel: "120.00" },
      { key: "uebernachtung", label: "Uebernachtungskosten", typ: "betrag", pflicht: false, beispiel: "95.00" },
      { key: "verpflegung", label: "Verpflegungspauschale", typ: "betrag", pflicht: false, beispiel: "28.00" },
      { key: "sonstiges", label: "Sonstige Kosten", typ: "betrag", pflicht: false, beispiel: "15.00" },
    ],
  },
  {
    id: "inventarliste",
    name: "Inventarliste",
    beschreibung: "Tabellarische Erfassung von Inventar / Anlagevermoegen (Excel).",
    format: "xlsx",
    agent: "Der Buchhalter",
    felder: [
      { key: "bezeichnung", label: "Bezeichnung des Gegenstands", typ: "text", pflicht: true, beispiel: "Laptop Dell XPS" },
      { key: "inventarnummer", label: "Inventarnummer", typ: "text", pflicht: false, beispiel: "INV-001" },
      { key: "anschaffungsdatum", label: "Anschaffungsdatum", typ: "text", pflicht: false, beispiel: "01.03.2025" },
      { key: "anschaffungswert", label: "Anschaffungswert", typ: "betrag", pflicht: false, beispiel: "1500.00" },
      { key: "standort", label: "Standort", typ: "text", pflicht: false, beispiel: "Buero 1" },
      { key: "zustand", label: "Zustand", typ: "text", pflicht: false, beispiel: "gut" },
    ],
  },
  {
    id: "budgetplan",
    name: "Budgetplan",
    beschreibung: "Einfache Budget- / Kostenplanung (Excel).",
    format: "xlsx",
    agent: "Der Buchhalter",
    felder: [
      { key: "posten", label: "Budgetposten", typ: "text", pflicht: true, beispiel: "Marketing" },
      { key: "kategorie", label: "Kategorie", typ: "text", pflicht: false, beispiel: "Fixkosten" },
      { key: "geplant", label: "Geplanter Betrag", typ: "betrag", pflicht: false, beispiel: "5000.00" },
