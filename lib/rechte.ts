...
export const NAV_LINKS: NavLink[] = [
  ...
  // Paket PC (24.09.26): Text-Werkstatt — ebenfalls Unterpfad von
  // /dashboard/marketing, deshalb ohne eigenen Modul-Schluessel.
  { label: '✍️ Text-Werkstatt', href: '/dashboard/marketing/texte', ebene: 3, gruppe: 'vertrieb' },
  ...
  { label: '💼 Projekt-Abrechnung', href: '/dashboard/projekt-abrechnung', modul: 'projekt-abrechnung', ebene: 3, sensibel: true, gruppe: 'vertrieb' },
  ...
  { label: '❤️ Spenden', href: '/dashboard/spenden', modul: 'spenden', ebene: 3, sensibel: true, gruppe: 'finanzen' },
  { label: '🚚 Tour & ePOD', href: '/dashboard/tour', modul: 'tour', ebene: 3, gruppe: 'betrieb' },
  { label: '📑 Gutachten', href: '/dashboard/gutachten', modul: 'gutachten', ebene: 3, gruppe: 'betrieb' },
  ...
  { label: '🧳 Reisekosten', href: '/dashboard/reisekosten', modul: 'reisekosten', ebene: 3, sensibel: true, gruppe: 'finanzen' },
  ...
  { label: '🧮 Nachkalkulation', href: '/dashboard/nachkalkulation', modul: 'controlling', ebene: 2, sensibel: true, gruppe: 'finanzen' },
  ...
  { label: '🧩 Filial-Module', href: '/dashboard/filial-module', nurChef: true, ebene: 1, gruppe: 'verwaltung' },
  { label: '📊 Filialvergleich', href: '/dashboard/filialvergleich', nurChef: true, ebene: 1, gruppe: 'verwaltung' },
  { label: '🎛 Wer sieht was', href: '/dashboard/wer-sieht-was', nurChef: true, ebene: 1, gruppe: 'verwaltung' },
