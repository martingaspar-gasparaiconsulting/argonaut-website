...
export type DemoBetrieb = {
  ...
  ziel: number;
  /**
   * Schlüssel der passenden ECHTEN Branchenseite auf der Website
   * (/vorschau/branchen/<webSlug>). Dorthin führt der QR-Code der Vorführung:
   * Der Besucher landet nicht auf einer Vorführung, sondern auf der Seite mit
   * Preisrechner und Terminbuchung. null = für diese Branche gibt es keine
...
export const DEMO_BETRIEBE: DemoBetrieb[] = [
  ...
  },
  {
    ...
    iban: 'DE10600501010004712233', bank: BANK, bic: BIC, ziel: 100, webSlug: 'hausverwaltungen',
  },
  {
    ...
    iban: 'DE94600501010004712370', bank: BANK, bic: BIC, ziel: 100, webSlug: 'werbeagenturen',
  },
  {
  ...
  },
  {
    ...
    iban: 'DE16600501010004713192', bank: BANK, bic: BIC, ziel: 100, webSlug: 'gartenbau',
  },
  {
  ...
  },
  {
    ...
    iban: 'DE87600501010004713466', bank: BANK, bic: BIC, ziel: 100, webSlug: 'wohlfahrtsverbaende',
  },
