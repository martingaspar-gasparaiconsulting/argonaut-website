...
const agenten = {
  solo: [
    { code: "A1", name: "Der Empfänger", beschreibung: "Onboarded neue Kunden automatisch" },
    { code: "A5", name: "Der Schreiber", beschreibung: "Erstellt Inhalte und Texte" },
  ],
  start: [
    { code: "A1", name: "Der Empfänger", beschreibung: "Onboarded neue Kunden automatisch" },
    { code: "A5", name: "Der Schreiber", beschreibung: "Erstellt Inhalte und Texte" },
    { code: "A3", name: "Der Wächter", beschreibung: "Überwacht alle laufenden Prozesse" },
    { code: "A4", name: "Der Buchhalter", beschreibung: "Automatisiert Buchhaltung und Rechnungen" },
    { code: "A6", name: "Der Planer", beschreibung: "Koordiniert Termine und Kalender" },
    { code: "A7", name: "Der Verkäufer", beschreibung: "Generiert Leads und Follow-ups" },
    { code: "B3", name: "Der Moderator", beschreibung: "Managed Community und Social Media" },
    { code: "B4", name: "Der Personalchef", beschreibung: "Automatisiert HR-Prozesse" },
  ],
  pro: [
    { code: "A2", name: "Der Schmied", beschreibung: "Baut und entwickelt Automatisierungen" },
    { code: "A8", name: "Der Regisseur", beschreibung: "Steuert Kampagnen und Marketing" },
    { code: "B1", name: "Der Forscher", beschreibung: "Analysiert Märkte und Wettbewerb" },
    { code: "B2", name: "Der Übersetzer", beschreibung: "Lokalisiert Inhalte in alle Sprachen" },
    { code: "B5", name: "Der Einkäufer", beschreibung: "Optimiert Beschaffung und Lieferanten" },
    { code: "C1", name: "Der Analyst", beschreibung: "Wertet Daten aus und erstellt Reports" },
    { code: "D1", name: "Der Techniker", beschreibung: "Wartet Systeme und IT-Infrastruktur" },
    { code: "E4", name: "Der Assistent", beschreibung: "Unterstützt täglich bei allen Aufgaben" },
  ],
  business: [
    { code: "C2", name: "Der Stratege", beschreibung: "Entwickelt Konzepte und Strategien" },
    { code: "C4", name: "Der Trainer", beschreibung: "Schult Mitarbeiter automatisch" },
    { code: "D2", name: "Der Sicherheitschef", beschreibung: "Schützt Daten und überwacht Compliance" },
    { code: "E1", name: "Der Netzwerker", beschreibung: "Pflegt Kontakte und Partnerschaften" },
  ],
  enterprise: [
    { code: "C3", name: "Der Jurist", beschreibung: "Prüft Verträge und rechtliche Dokumente" },
    { code: "D3", name: "Der Integrator", beschreibung: "Verbindet alle Systeme und APIs" },
    { code: "E2", name: "Der Botschafter", beschreibung: "Repräsentiert die Marke nach außen" },
    { code: "E3", name: "Der Späher", beschreibung: "Beobachtet Wettbewerb und Märkte" },
  ],
};
