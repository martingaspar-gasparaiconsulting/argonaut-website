...
const plans = [
  {
    ...
    highlight: false,
    badge: "",
    description: "Für Solopreneure & Teams bis 3 Personen",
    features: ["2 KI-Agenten", "25 Automatisierungen", "1 Standort", "E-Mail Support", "Upgrade ab Woche 10"],
    cta: "Jetzt starten",
    stripeLink: "#",
  },
  {
    ...
    features: ["8 KI-Agenten", "25 Automatisierungen inkl.", "Basis-Paket inklusive", "1 Standort", "Priority Support"],
    cta: "Jetzt starten",
    stripeLink: "#",
  },
  {
    ...
    description: "Für etablierte Mittelständler",
    features: ["16 KI-Agenten", "25 Automatisierungen inkl.", "Basis-Paket inklusive", "1 Standort", "Dedizierter Support"],
    cta: "Jetzt starten",
    stripeLink: "#",
  },
  {
    ...
    features: ["20 KI-Agenten", "25 Automatisierungen inkl.", "Basis-Paket inklusive", "1 Standort", "Account Manager"],
    cta: "Jetzt starten",
    stripeLink: "#",
  },
  {
    ...
    highlight: false,
    badge: "",
    description: "Volle KI-Power für Ihr Unternehmen",
    features: ["24 KI-Agenten", "25 Automatisierungen inkl.", "Basis-Paket inklusive", "1 Standort", "VIP Support & Onboarding"],
    cta: "Jetzt starten",
    stripeLink: "#",
  },
];
    ...
    <section id="preise" style={{ backgroundColor: "#ffffff", padding: "80px 24px" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "16px" }}>
          ...
          <p style={{ fontSize: "16px", color: "#666", maxWidth: "560px", margin: "0 auto 12px", lineHeight: 1.6 }}>Alle Pakete beinhalten das Basis-Paket (1.500 €/Monat) mit 25 Automatisierungen.</p>
          <p style={{ fontSize: "13px", color: "#999" }}>Alle Preise zzgl. 19% MwSt. · Monatlich kündbar</p>
        </div>
        <div style={{ background: "#f8f6f0", border: "1px solid #e8dfc8", borderRadius: "12px", padding: "16px 24px", textAlign: "center", maxWidth: "700px", margin: "24px auto 48px" }}>
          <p style={{ fontSize: "14px", color: "#0D1B3E" }}><strong>Basis-Paket 1.500 €/Monat</strong> ist Pflichtbestandteil aller Pakete — 25 Automatisierungen, Infrastruktur & Support inklusive.</p>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(210px, 1fr))", gap: "20px", alignItems: "stretch" }}>
          {plans.map((plan) => (
            <div key={plan.name} style={{ background: plan.highlight ? "#0D1B3E" : "#ffffff", border: plan.highlight ? "2px solid #C9A84C" : "1px solid #e5e5e5", borderRadius: "16px", padding: "28px 22px", display: "flex", flexDirection: "column", position: "relative" }}>
              {plan.badge && (
                <div style={{ position: "absolute", top: "-13px", left: "50%", transform: "translateX(-50%)", background: "#C9A84C", color: "#fff", fontSize: "11px", fontWeight: 700, padding: "4px 16px", borderRadius: "20px", whiteSpace: "nowrap" }}>{plan.badge}</div>
              )}
              ...
              <div style={{ marginBottom: "8px" }}>
                <span style={{ fontSize: "36px", fontWeight: 800, color: plan.highlight ? "#ffffff" : "#0D1B3E", lineHeight: 1 }}>{plan.price} €</span>
