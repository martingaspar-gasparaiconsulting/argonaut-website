...
// ============================================================
// ARGONAUT OS · I1a · Öffentliche Bestellstrecke — Gerüst (DUNKEL)
// Schritt 1 (Paket/Stufe) + Schritt 2 (Sitze) + Live-Preis aus lib/tarif.
// Weitere Schritte (Laufzeit, §14, Firmendaten, SEPA, AGB) folgen in
// I1b–I1d. Solange flags.BESTELLSTRECKE_LIVE === false ist die Strecke
// NICHT verlinkt und die verbindliche Bestellung deaktiviert.
// Pfad: app/buchen/page.tsx
// ============================================================

import { useState, CSSProperties } from 'react';
import {
  STUFEN, SITZ, sitzPreis, angebotssumme, euro,
  type StufeKey, type SitzTyp, type Sitzbelegung,
} from '../../lib/tarif';
...
const SCHRITTE = ['Paket', 'Nutzer', 'Überblick'];
...
export default function BuchenPage() {
  ...
  const summe = stufeKey ? angebotssumme(stufeKey, sitze, 12) : null;
  ...
  const kannWeiter = schritt === 1 ? !!stufeKey : true;
      ...
      <div style={styles.page}>
        ...
        <div style={styles.grid}>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            {schritt === 3 && (
              <div style={styles.card}>
                <div style={styles.cardTitel}>3 · Überblick</div>
                <p style={styles.dim}>
                  Das ist Ihre unverbindliche Zusammenstellung. Die weiteren Schritte
                  (Laufzeit, Firmendaten, SEPA-Mandat, AGB) folgen in Kürze.
                </p>
          ...
          <aside style={styles.seite}>
            ...
            {!summe ? (
              ...
              <>
                ...
                <div style={styles.seiteFuss}>Alle Preise netto zzgl. USt. Laufzeit-Rabatt wählen Sie im nächsten Schritt.</div>
              </>
            )}
          </aside>
        </div>
...
const styles: Record<string, CSSProperties> = {
  ...
  stepLinie: { width: 'clamp(16px,4vw,48px)', height: 1, background: C.border, margin: '0 4px' },
