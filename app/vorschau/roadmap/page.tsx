...
const ITEMS: Item[] = [
  ...
  { status: 'verfuegbar', tag: 'Landwirtschaft', name: 'Landwirtschaft & Forst', nutzen: 'Schlagkartei: Flächen mit Kultur + dokumentierte Maßnahmen (Aussaat/Düngung/Pflanzenschutz/Ernte)' },
  { status: 'verfuegbar', tag: 'Tiere', name: 'Tier-Fachpaket', nutzen: 'Tierkartei mit Halter + Behandlungen/Impfungen mit Wiederholungs-Fälligkeit (Ampel)' },
