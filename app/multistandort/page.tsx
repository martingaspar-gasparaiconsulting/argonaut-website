  ...
  return (
    <main style={{
      ...
      <section style={{ padding: '80px 24px', maxWidth: '700px', margin: '0 auto', textAlign: 'center' }}>
        ...
        <a href="/#preise" style={{ display: 'inline-block', background: '#C9A84C', color: '#0A1628', fontWeight: 700, fontSize: '13px', padding: '20px 48px', letterSpacing: '0.15em', textTransform: 'uppercase', textDecoration: 'none', borderRadius: '4px', marginBottom: '16px' }}>
