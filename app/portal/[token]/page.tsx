...
type Rechnung = { nummer: string; titel: string; datum: string | null; faellig: string | null; betrag: number; status: string; bezahlt: boolean };
...
const styles: Record<string, CSSProperties> = {
  ...
  termin: { display: 'flex', gap: 14, alignItems: 'center', padding: '12px 14px', background: C.navy, border: `1px solid ${C.border}`, borderRadius: 12 },
