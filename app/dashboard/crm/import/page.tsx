    ...
    <div style={styles.page}>
      ...
      {schritt === 2 && csv && (
        <div style={styles.card}>
          ...
          <div style={{ fontSize: 'clamp(12.5px, 1.13vw, 18px)', color: C.textDim, marginBottom: 14, lineHeight: 1.55 }}>
      ...
      {schritt === 3 && befund && plan && (
        <>
          ...
          <div style={styles.card}>
            ...
            <div style={{ fontSize: 'clamp(12.5px, 1.13vw, 18px)', color: C.textDim, margin: '8px 0 14px', lineHeight: 1.55 }}>
            ...
            <div style={styles.summeZeile}>
              <span style={{ color: C.textDim, fontSize: 'clamp(13px, 1.13vw, 18px)' }}>{uebernahmeKlartext(plan)}</span>
...
function ZeilenReihe({ z, onAktion }: { z: ImportZeile; onAktion: (nr: number, a: ZeilenAktion) => void }) {
  ...
  return (
    <tr style={{ opacity: kaputt ? 0.55 : 1 }}>
      ...
      <td style={{ ...styles.td, color: farbe, fontSize: 'clamp(12.5px, 1.13vw, 18px)' }}>{statusText(z.status)}</td>
...
const styles: Record<string, CSSProperties> = {
  ...
  input: { width: '100%', boxSizing: 'border-box', background: C.navy, color: C.text, border: `1px solid ${C.border}`, borderRadius: 8, padding: '8px 10px', fontSize: 'clamp(13.5px, 1.19vw, 19px)', fontFamily: 'inherit' },
  ...
  miniBtn: { background: 'rgba(224,162,76,0.12)', color: C.warn, border: `1px solid rgba(224,162,76,0.3)`, borderRadius: 8, padding: '6px 12px', fontSize: 'clamp(12.5px, 1.13vw, 18px)', fontWeight: 700, fontFamily: 'inherit', cursor: 'pointer' },
