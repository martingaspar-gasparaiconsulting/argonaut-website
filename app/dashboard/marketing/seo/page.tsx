...
// ============================================================
// ARGONAUT OS · MODUL 3 MARKETING · SEO-Modul (Punkt 6)
// Prüft die eigene(n) Webseite(n) gegen die wichtigsten On-Page-SEO-Faktoren,
// zeigt je Seite einen Score + konkrete Tipps und liefert lokale Keyword-Ideen.
        ...
        <>
          {daten.seiten.length === 0 ? (
            <div style={{ background: C.navy2, border: `1px dashed ${C.border}`, borderRadius: 14, padding: 24, color: C.textDim, fontSize: 14.5, lineHeight: 1.6 }}>
              Noch keine Website gefunden. Sobald du im Website-Baukasten eine Seite angelegt und veröffentlicht hast, prüft der SEO-Check sie hier automatisch und zeigt dir konkrete Verbesserungen.
