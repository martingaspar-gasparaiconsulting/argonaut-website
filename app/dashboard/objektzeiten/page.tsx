  ...
  return (
    <div style={styles.page}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-end' }}>
              <button
                ...
                style={{
                  ...
                  color: zeitForm.abrechenbar ? C.text : C.textDim, fontSize: 'clamp(13px, 1.13vw, 18px)', cursor: 'pointer', fontFamily: 'inherit',
                }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, margin: '22px 0 14px' }}>
        ...
        <span style={{ minWidth: 150, textAlign: 'center', fontWeight: 700, fontFamily: "var(--font-dm-sans), sans-serif", fontSize: 'clamp(16px, 1.38vw, 22px)' }}>{monatsName}</span>
        <button style={styles.navBtn} onClick={() => setMonat(new Date(monat.getFullYear(), monat.getMonth() + 1, 1))}>›</button>
      </div>
