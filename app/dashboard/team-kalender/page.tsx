...
const styles: Record<string, CSSProperties> = {
  ...
  h1: { fontFamily: "'Syne', sans-serif", fontSize: 30, fontWeight: 700, margin: 0, color: C.text },
  ...
  monatLabel: { fontFamily: "'Syne', sans-serif", fontSize: 18, fontWeight: 700, color: C.text, marginLeft: 8, minWidth: 150 },
