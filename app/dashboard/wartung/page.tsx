...
const styles: Record<string, CSSProperties> = {
  ...
  miniBtn: { background: 'rgba(0,229,255,0.12)', color: C.cyan, border: `1px solid rgba(0,229,255,0.3)`, borderRadius: 8, padding: '5px 10px', fontSize: 12.5, fontWeight: 700, fontFamily: 'inherit', cursor: 'pointer', marginLeft: 6 },
  ...
  td: { padding: '11px 10px', fontSize: 14, borderBottom: '1px solid rgba(143,163,190,0.08)', verticalAlign: 'top' },
