    ...
    <section id="kontakt" style={{ background: '#ffffff' }} className="py-32 px-8 text-center">
      <div className="max-w-[800px] mx-auto">
        <div className="flex justify-center items-center gap-3 mb-8">
          ...
          <span className="text-[#c9a84c] text-sm tracking-[0.2em] uppercase font-[family-name:var(--font-syne)] font-semibold">Live-Demo</span>
          <span className="inline-block w-8 h-px bg-[#c9a84c]" />
        </div>
        ...
        <a href="#kontakt" className="inline-block font-[family-name:var(--font-syne)] font-bold text-sm tracking-[0.12em] uppercase px-14 py-5 bg-[#c9a84c] text-[#0d1b2e] hover:bg-[#e0b85a] transition-all duration-200 rounded-full">
